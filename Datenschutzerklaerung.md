...
Zur anonymen Reichweiten- und Erfolgsmessung (z. B. welche Einstiegsseite zu einer Registrierung führt) setzen wir Umami ein. Anbieter ist die Umami Software, Inc., 28 Geary St, Suite 650 #243, San Francisco, CA, USA. Die Datenverarbeitung erfolgt auf Servern in der EU-Region (Deutschland).

Umami arbeitet ohne Cookies und ohne Local Storage. Zur Wiedererkennung von Sitzungen wird ein täglich neu erzeugter, nicht rückverfolgbarer Hash-Wert verwendet; IP-Adressen werden nicht gespeichert. Es werden keine individuellen Nutzerprofile gebildet.

Erfasst werden aufgerufene Seiten, Referrer sowie grobe Geräte- und Browserinformationen. Zusätzlich werden folgende Ereignisse erfasst: Beginn und Abschluss einer Registrierung, Beginn eines Bezahlvorgangs sowie erfolgreicher Abschluss eines Pro-Abonnements.

Da keine personenbezogenen Daten über Cookies oder vergleichbare Wiedererkennungsverfahren verarbeitet werden, ist keine Einwilligung erforderlich. Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Analyse und Verbesserung des Angebots). Ein AVV wurde abgeschlossen. Weitere Informationen: https://umami.is/privacy
